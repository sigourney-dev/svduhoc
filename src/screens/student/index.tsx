...
export const StudentScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <TabHeaderCustom title="Sinh viên" isBack />
      <ScrollView showsVerticalScrollIndicator={false} style={styles.wrapper}>
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>Du học cùng SVDUHOC.VN</Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>VISA D</Text>
          <FlatList
          showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>Du học tiếng D4</Text>
          <FlatList
          showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
