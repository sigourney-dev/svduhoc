...
export const FamilyScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <TabHeaderCustom title="Định cư" isBack />
      <ScrollView showsVerticalScrollIndicator={false} style={styles.wrapper}>
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>Quốc tịch</Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>VISA F</Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
        ...
        <View style={styles.wrapperBox}>
          <Text style={{...TS.textLgMedium}}>Cô dâu và quốc tịch</Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal
            data={dataList}
